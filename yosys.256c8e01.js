...
importScripts("./yosys.53a6eedd.js");
parcelRequire.register("i7QMC", function(module, exports) {

var $6vt9n = parcelRequire("6vt9n");

var $9dvvU = parcelRequire("9dvvU");
"use strict";
var __dirname = "node_modules/yosys/dist";
...
var fs_1 = __importDefault((parcelRequire("ksweO")));

var path_1 = __importDefault((parcelRequire("bvcWa")));

var $1pCNZ = parcelRequire("1pCNZ");

var $9l8EN = parcelRequire("9l8EN");
var Yosys = /*#__PURE__*/ function() {
    function Yosys(module) {
        $6vt9n.classCallCheck(this, Yosys);
        this.module = module;
    }
    $6vt9n.createClass(Yosys, [
        {
            key: "getModule",
        ...
        },
        {
            ...
            value: function initialize() {
                ...
                return $6vt9n.asyncToGenerator((/*@__PURE__*/$parcel$interopDefault($9dvvU)).mark(function _callee() {
                    var wasmBinary, args;
                    return (/*@__PURE__*/$parcel$interopDefault($9dvvU)).wrap(function _callee$(_ctx) {
                        while(1)switch(_ctx.prev = _ctx.next){
                            case 0:
                                wasmBinary = _param.wasmBinary, args = $6vt9n.objectWithoutProperties(_param, [
                                    "wasmBinary"
                                ]);
                                _ctx.t0 = Yosys;
                                _ctx.next = 4;
                                return $9l8EN($6vt9n.objectSpread({
                                    wasmBinary: wasmBinary ? wasmBinary : fs_1.default.readFileSync(path_1.default.join(__dirname, 'yosys.wasm'))
                                }, args));
                            case 4:
                                _ctx.t1 = _ctx.sent;
                                return _ctx.abrupt("return", new _ctx.t0(_ctx.t1));
                            case 6:
                            case "end":
                                return _ctx.stop();
                        }
...
parcelRequire.register("1pCNZ", function(module, exports) {
module.exports = JSON.parse("{\"name\":\"yosys\",\"description\":\"WebAssembly version of Yosys.\",\"version\":\"0.17.3\",\"license\":\"MIT\",\"contributors\":[\"Daniel Huisman <daniel@huisman.me> (https://danielhuisman.io)\"],\"repository\":\"github:EDAcation/yosys.js\",\"keywords\":[\"yosys\",\"fpga\",\"rtl\",\"synthesis\",\"webassembly\",\"wasm\"],\"main\":\"./dist/index.js\",\"types\":\"./dist/index.d.ts\",\"files\":[\"dist\",\"LICENSE.md\",\"README.md\",\"package.json\"],\"scripts\":{\"lint\":\"eslint\",\"clean\":\"rm -rf dist && mkdir -p dist && cp build/yosys.* dist\",\"build\":\"yarn run clean && yarn run lint && tsc\",\"dev\":\"yarn run clean && tsc --watch\"},\"dependencies\":{\"@types/emscripten\":\"^1.39.6\",\"@types/node\":\"^17.0.22\"},\"devDependencies\":{\"@typescript-eslint/eslint-plugin\":\"^5.16.0\",\"@typescript-eslint/parser\":\"^5.16.0\",\"eslint\":\"^8.11.0\",\"eslint-config-google\":\"^0.14.0\",\"eslint-plugin-import\":\"^2.25.4\",\"ts-node\":\"^10.7.0\",\"typescript\":\"^4.6.2\"}}");

});

parcelRequire.register("9l8EN", function(module, exports) {

var $5vuHX = parcelRequire("5vuHX");
var $6cccca504422c0ba$require$Buffer = $5vuHX.Buffer;

var $iUMdb = parcelRequire("iUMdb");
var $6cccca504422c0ba$var$__filename = "node_modules/yosys/dist/yosys.node.js";
var $6cccca504422c0ba$var$__dirname = "node_modules/yosys/dist";




var $6cccca504422c0ba$var$Yosys = function() {
    var _scriptDir = typeof document !== 'undefined' && document.currentScript ? document.currentScript.src : undefined;
    if (typeof $6cccca504422c0ba$var$__filename !== 'undefined') _scriptDir = _scriptDir || $6cccca504422c0ba$var$__filename;
    return function(Yosys) {
        Yosys = Yosys || {};
        ...
        if (!Object.getOwnPropertyDescriptor(Module['ready'], '_run')) {
            Object.defineProperty(Module['ready'], '_run', {
                configurable: true,
                get: function get() {
                    abort('You are getting _run on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js');
                }
            });
            Object.defineProperty(Module['ready'], '_run', {
                configurable: true,
                set: function set() {
                    abort('You are setting _run on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js');
                }
            });
        }
        if (!Object.getOwnPropertyDescriptor(Module['ready'], '_prompt')) {
            Object.defineProperty(Module['ready'], '_prompt', {
                configurable: true,
                get: function get() {
                    abort('You are getting _prompt on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js');
                }
            });
            Object.defineProperty(Module['ready'], '_prompt', {
                configurable: true,
                set: function set() {
                    abort('You are setting _prompt on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js');
                }
            });
        }
        if (!Object.getOwnPropertyDescriptor(Module['ready'], '_errmsg')) {
            Object.defineProperty(Module['ready'], '_errmsg', {
                configurable: true,
                get: function get() {
                    abort('You are getting _errmsg on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js');
                }
            });
            Object.defineProperty(Module['ready'], '_errmsg', {
                configurable: true,
                set: function set() {
                    abort('You are setting _errmsg on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js');
                }
            });
        }
        ...
        (function() {
            ...
            var loadPackage = function loadPackage(metadata) {
                function runWithFS() {
                    ...
                    Module['FS_createPath']("/share/include/libs", "fst", true, true);
        ...
        var ENVIRONMENT_IS_NODE = typeof $iUMdb == 'object' && typeof $iUMdb.versions == 'object' && typeof $iUMdb.versions.node == 'string';
        ...
        if (ENVIRONMENT_IS_NODE) {
            if (!(typeof $iUMdb == 'object' && true)) throw new Error('not compiled for this environment (did you build to HTML and try to run it not on the web, or set ENVIRONMENT to something - like node - and run it someplace else - like on the web?)');
            if (ENVIRONMENT_IS_WORKER) scriptDirectory = (parcelRequire("bvcWa")).dirname(scriptDirectory) + '/';
            else scriptDirectory = $6cccca504422c0ba$var$__dirname + '/';
            ...
            requireNodeFS = function() {
                ...
                // created.
                if (!nodePath) {
                    fs = (parcelRequire("ksweO"));
                    nodePath = (parcelRequire("bvcWa"));
                }
            };
            ...
            if ($iUMdb['argv'].length > 1) thisProgram = $iUMdb['argv'][1].replace(/\\/g, '/');
            arguments_ = $iUMdb['argv'].slice(2);
            // MODULARIZE will export the module in the proper place outside, we don't need to export here
            $iUMdb['on']('uncaughtException', function(ex) {
            ...
            $iUMdb['on']('unhandledRejection', function(reason) {
                throw reason;
            });
            quit_ = function(status, toThrow) {
                if (keepRuntimeAlive()) {
                    $iUMdb['exitCode'] = status;
                    throw toThrow;
                }
            ...
            if (typeof $iUMdb == 'object' && true || typeof window == 'object' || typeof importScripts == 'function') throw new Error('not compiled for this environment (did you build to HTML and try to run it not on the web, or set ENVIRONMENT to something - like node - and run it someplace else - like on the web?)');
            ...
            if (typeof quit == 'function') quit_ = function(status, toThrow) {
                logExceptionOnExit(toThrow);
                quit(status);
            };
        ...
        function getNativeTypeSize(type) {
            switch(type){
                ...
                case 'double':
                    return 8;
                default:
                    if (type[type.length - 1] === '*') return POINTER_SIZE;
                    else if (type[0] === 'i') {
        ...
        function convertJsFunctionToWasm(func, sig) {
            ...
            if (sigRet == 'v') typeSection.push(0x00);
            ...
            var _$module = new WebAssembly.Module(bytes);
            var instance = new WebAssembly.Instance(_$module, {
                'e': {
                    'f': func
                }
            });
 ...
 */ function addFunction(func, sig) {
        ...
        function unexportedMessage(sym, isFSSybol) {
            ...
            if (isFSSybol) msg += '. Alternatively, forcing filesystem support (-sFORCE_FILESYSTEM) can export this for you';
            return msg;
        }
        ...
        function unexportedRuntimeFunction(sym, isFSSybol) {
            if (!Object.getOwnPropertyDescriptor(Module, sym)) Module[sym] = function() {
    ...
    @param {Object=} opts */ function ccall(ident, returnType, argTypes, args, opts) {
    ...
    @param {Array=} argTypes
    @param {Object=} opts */ function cwrap(ident, returnType, argTypes, opts) {
            return function() {
 ...
 */ function UTF8ToString(ptr, maxBytesToRead) {
        ...
        /** @deprecated
    @param {boolean=} dontAddNull */ function writeStringToMemory(string, buffer, dontAddNull) {
        ...
        /** @param {boolean=} dontAddNull */ function writeAsciiToMemory(str, buffer, dontAddNull) {
            for(var i = 0; i < str.length; ++i){
        ...
        // Memory management
        var HEAP, /** @type {!ArrayBuffer} */ buffer1, /** @type {!Int8Array} */ HEAP8, /** @type {!Uint8Array} */ HEAPU8, /** @type {!Int16Array} */ HEAP16, /** @type {!Uint16Array} */ HEAPU16, /** @type {!Int32Array} */ HEAP32, /** @type {!Uint32Array} */ HEAPU32, /** @type {!Float32Array} */ HEAPF32, /** @type {!Float64Array} */ HEAPF64;
        ...
        function checkStackCookie() {
            ...
            if (cookie1 != 0x2135467 || cookie2 != 0x89BACDFE) abort('Stack overflow! Stack cookie has been overwritten, expected hex dwords 0x89BACDFE and 0x2135467, but received 0x' + cookie2.toString(16) + ' 0x' + cookie1.toString(16));
            // Also test the global address 0 for integrity.
        ...
        function getBinaryPromise() {
            ...
            if (!wasmBinary && (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER)) {
                if (typeof fetch == 'function' && !isFileURI(wasmBinaryFile)) return fetch(wasmBinaryFile, {
                    ...
                    if (readAsync) // fetch is not available or url is file => try XHR (readAsync uses XHR internally)
        ...
        function createWasm() {
            ...
            function instantiateAsync() {
                ...
                !isFileURI(wasmBinaryFile) && typeof fetch == 'function') return fetch(wasmBinaryFile, {
                    credentials: 'same-origin'
                }).then(function(response) {
                    ...
                    /** @suppress {checkTypes} */ var result = WebAssembly.instantiateStreaming(response, info);
        ...
        function callRuntimeCallbacks(callbacks) {
            while(callbacks.length > 0){
                ...
                if (typeof func == 'number') {
                    if (callback.arg === undefined) // Run the wasm function ptr with signature 'v'. If no function
                    // with such signature was exported, this call does not need
                    // to be emitted (and would confuse Closure)
                    getWasmTableEntry(func)();
                    else // If any function with signature 'vi' was exported, run
     ...
     */ function setValue(ptr, value) {
        ...
        function getRandomDevice() {
            ...
            try {
                var crypto_module = (parcelRequire("dncZy"));
                ...
                get_char: function get_char(tty) {
                    if (!tty.input.length) {
                        ...
                        if (ENVIRONMENT_IS_NODE) {
                            ...
                            var BUFSIZE = 256;
                            var buf = $6cccca504422c0ba$require$Buffer.alloc(BUFSIZE);
                            var bytesRead = 0;
                            try {
                                bytesRead = fs.readSync($iUMdb.stdin.fd, buf, 0, BUFSIZE, -1);
                            } catch (e) {
        ...
        var MEMFS = {
            ...
            stream_ops: {
                ...
                msync: function msync(stream, buffer, offset, length, mmapFlags) {
                    if (!FS.isFile(stream.node.mode)) throw new FS.ErrnoError(43);
                    if (mmapFlags & 2) // MAP_PRIVATE calls need not to be synced back to underlying fs
                    return 0;
        ...
        var NODEFS = {
            isWindows: false,
            staticInit: function() {
                NODEFS.isWindows = !!$iUMdb.platform.match(/^win/);
                var flags = $iUMdb["binding"]("constants");
            ...
            createNode: function(parent, name, mode, dev) {
                if (!FS.isDir(mode) && !FS.isFile(mode) && !FS.isLink(mode)) throw new FS.ErrnoError(28);
            ...
            getMode: function(path) {
                ...
                try {
                    ...
                    if (NODEFS.isWindows) // Node.js on Windows never represents permission bit 'x', so
            ...
            flagsForNode: function(flags) {
                flags &= -2097153; // Ignore this flag from musl, otherwise node.js fails to open the file.
                flags &= -2049; // Ignore this flag from musl, otherwise node.js fails to open the file.
                flags &= -32769; // Ignore this flag from musl, otherwise node.js fails to open the file.
                flags &= -524289; // Some applications may pass it; it makes no sense for a single process.
                flags &= -65537; // Node.js doesn't need this passed in, it errors.
                var newFlags = 0;
                for(var k in NODEFS.flagsForNodeMap)if (flags & k) {
                    newFlags |= NODEFS.flagsForNodeMap[k];
                    flags ^= k;
                }
                if (!flags) return newFlags;
            ...
            stream_ops: {
                open: function(stream) {
                    ...
                    try {
                        if (FS.isFile(stream.node.mode)) stream.nfd = fs.openSync(path, NODEFS.flagsForNode(stream.flags));
                    } catch (e) {
                        if (!e.code) throw e;
                        throw new FS.ErrnoError(NODEFS.convertNodeCode(e));
                    }
                ...
                close: function(stream) {
                    try {
                        if (FS.isFile(stream.node.mode) && stream.nfd) fs.closeSync(stream.nfd);
                    } catch (e) {
                        if (!e.code) throw e;
                        throw new FS.ErrnoError(NODEFS.convertNodeCode(e));
                    }
                ...
                read: function(stream, buffer, offset, length, position) {
                    ...
                    try {
                        return fs.readSync(stream.nfd, $6cccca504422c0ba$require$Buffer.from(buffer.buffer), offset, length, position);
                    } catch (e) {
                        throw new FS.ErrnoError(NODEFS.convertNodeCode(e));
                    }
                },
                write: function(stream, buffer, offset, length, position) {
                    try {
                        return fs.writeSync(stream.nfd, $6cccca504422c0ba$require$Buffer.from(buffer.buffer), offset, length, position);
                    } catch (e) {
                        throw new FS.ErrnoError(NODEFS.convertNodeCode(e));
                    }
                },
                llseek: function(stream, offset, whence) {
                    ...
                    if (whence === 1) position += stream.position;
                        ...
                        if (FS.isFile(stream.node.mode)) try {
            ...
            node_ops: {
                ...
                mknod: function mknod(parent, name, mode, dev) {
                    ...
                    try {
                        ...
                        else node.mount.opts.fs.writeFile(path, '', {
                            mode: node.mode
                        });
                    } catch (e) {
                        if (!e.code) throw e;
        ...
        var FS = {
            ...
            MAX_OPEN_FDS: 4096,
            nextfd: function() {
                var fd_start = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, fd_end = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : FS.MAX_OPEN_FDS;
            ...
            ensureErrnoError: function() {
                ...
                FS.ErrnoError = /** @this{Object} */ function ErrnoError(errno1, node) {
                    this.node = node;
                    ...
                    this.message = ERRNO_MESSAGES[errno1];
            ...
            createPreloadedFile: function(parent, name, url, canRead, canWrite, onload, onerror, dontCreateFile, canOwn, preFinish) {
                ...
                function processData(byteArray1) {
                    ...
                    if (Browser.handledByPreloadPlugin(byteArray1, fullname, finish, function() {
                        if (onerror) onerror();
                        removeRunDependency(dep);
                    })) return;
                    finish(byteArray1);
        ...
        function ___syscall_faccessat(dirfd, path, amode, flags) {
            try {
                ...
                if (amode & 2) perms += 'w';
                if (amode & 1) perms += 'x';
                if (perms /* otherwise, they've just passed F_OK */  && FS.nodePermissions(node, perms)) return -2;
                return 0;
            } catch (e) {
                if (typeof FS == 'undefined' || !(e instanceof FS.ErrnoError)) throw e;
                return -e.errno;
            ...
            try {
                ...
                while(idx < stream.getdents.length && pos + struct_size <= count){
                    ...
                    if (name === '.') {
                        ...
                        id = child.id;
                        type = FS.isChrdev(child.mode) ? 2 : FS.isDir(child.mode) ? 4 : FS.isLink(child.mode) ? 10 : 8; // DT_REG, regular file.
                    }
                    assert(id);
                    tempI64 = [
                        id >>> 0,
                        (tempDouble = id, +Math.abs(tempDouble) >= 1.0 ? tempDouble > 0.0 ? (Math.min(+Math.floor(tempDouble / 4294967296.0), 4294967295.0) | 0) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296.0) >>> 0 : 0)
                    ], HEAP32[dirp + pos >> 2] = tempI64[0], HEAP32[dirp + pos + 4 >> 2] = tempI64[1];
                    tempI64 = [
                        (idx + 1) * struct_size >>> 0,
                        (tempDouble = (idx + 1) * struct_size, +Math.abs(tempDouble) >= 1.0 ? tempDouble > 0.0 ? (Math.min(+Math.floor(tempDouble / 4294967296.0), 4294967295.0) | 0) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296.0) >>> 0 : 0)
        ...
        function readAsmConstArgs(sigPtr, buf) {
            ...
            while(ch = HEAPU8[sigPtr++]){
                ...
                buf += ch != 105 /*i*/  & buf;
                readAsmConstArgsArray.push(ch == 105 /*i*/  ? HEAP32[buf] : HEAPF64[(buf++) >> 1]);
                ++buf;
            }
        ...
        if (ENVIRONMENT_IS_NODE) _emscripten_get_now = function() {
            var t = $iUMdb['hrtime']();
        ...
        function _strftime(s, maxsize, format, tm) {
            ...
            for(var rule in EXPANSION_RULES_2)if (pattern.includes(rule)) pattern = pattern.replace(new RegExp(rule, 'g'), EXPANSION_RULES_2[rule](date3));
 ...
 */ var decodeBase64 = typeof atob == 'function' ? atob : function decodeBase64(input) {
        ...
        function intArrayFromBase64(s) {
            if (typeof ENVIRONMENT_IS_NODE == 'boolean' && ENVIRONMENT_IS_NODE) {
                var buf = $6cccca504422c0ba$require$Buffer.from(s, 'base64');
        ...
        /** @type {function(...*):?} */ var _main = Module["_main"] = createExportWrapper("main");
        /** @type {function(...*):?} */ var _run = Module["_run"] = createExportWrapper("run");
        /** @type {function(...*):?} */ var _errmsg = Module["_errmsg"] = createExportWrapper("errmsg");
        /** @type {function(...*):?} */ var _prompt = Module["_prompt"] = createExportWrapper("prompt");
        ...
        /** @type {function(...*):?} */ var _memset = Module["_memset"] = createExportWrapper("memset");
        ...
        /** @type {function(...*):?} */ var ___cxa_is_pointer_type = Module["___cxa_is_pointer_type"] = createExportWrapper("__cxa_is_pointer_type");
        /** @type {function(...*):?} */ var dynCall_viijii = Module["dynCall_viijii"] = createExportWrapper("dynCall_viijii");
        /** @type {function(...*):?} */ var dynCall_vijii = Module["dynCall_vijii"] = createExportWrapper("dynCall_vijii");
        /** @type {function(...*):?} */ var dynCall_vijiii = Module["dynCall_vijiii"] = createExportWrapper("dynCall_vijiii");
        ...
        var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 6251420;
 ...
 */ function ExitStatus(status) {
        ...
        /** @param {boolean|number=} implicit */ function exit(status, implicit) {
            EXITSTATUS = status;
...
module.exports = $6cccca504422c0ba$var$Yosys;

});


var $4cb31379c8be648f$exports = {};

$parcel$export($4cb31379c8be648f$exports, "WorkerYosys", function () { return $4cb31379c8be648f$export$47d7610350220620; });

var $6vt9n = parcelRequire("6vt9n");

var $9dvvU = parcelRequire("9dvvU");

var $i7QMC = parcelRequire("i7QMC");

var $cYEEb = parcelRequire("cYEEb");
var $4cb31379c8be648f$export$47d7610350220620 = /*#__PURE__*/ function(WorkerTool) {
    "use strict";
    $6vt9n.inherits($4cb31379c8be648f$export$47d7610350220620, WorkerTool);
    var _super = $6vt9n.createSuper($4cb31379c8be648f$export$47d7610350220620);
    function $4cb31379c8be648f$export$47d7610350220620() {
        $6vt9n.classCallCheck(this, $4cb31379c8be648f$export$47d7610350220620);
        return _super.apply(this, arguments);
    }
    $6vt9n.createClass($4cb31379c8be648f$export$47d7610350220620, [
        {
            key: "initialize",
            value: function initialize() {
                return $6vt9n.asyncToGenerator((/*@__PURE__*/$parcel$interopDefault($9dvvU)).mark(function _callee() {
                    var response, wasmBinary, yosys;
                    return (/*@__PURE__*/$parcel$interopDefault($9dvvU)).wrap(function _callee$(_ctx) {
                        while(1)switch(_ctx.prev = _ctx.next){
                            case 0:
                                _ctx.next = 2;
                                return fetch("https://unpkg.com/yosys@".concat($i7QMC.Yosys.getVersion(), "/dist/yosys.wasm"));
                            case 2:
                                response = _ctx.sent;
                                _ctx.next = 5;
                                return response.arrayBuffer();
                            case 5:
                                wasmBinary = _ctx.sent;
                                _ctx.next = 8;
                                return $i7QMC.Yosys.initialize({
                            ...
                            case 8:
                                yosys = _ctx.sent;
                                return _ctx.abrupt("return", yosys);
                            case 10:
                            case "end":
                                return _ctx.stop();
                        }
                    ...
                    return (/*@__PURE__*/$parcel$interopDefault($9dvvU)).wrap(function _callee$(_ctx) {
                        while(1)switch(_ctx.prev = _ctx.next){
                            ...
                            case 3:
                                ...
                                _this.tool.getFS().writeFile("design.".concat(extension), content);
                                _this.tool.getFS().writeFile("design.ys", "\n            design -reset;\n            design -reset-vlog;\n            read_verilog design.".concat(extension, ";\n            proc;\n            opt;\n            show;\n            synth_ice40 -json luts.json;\n        "));
                                // @ts-expect-error: ccall does not exist on type
                                _this.tool.getModule().ccall('run', '', [
                                    'string'
                                ], [
                                    'script design.ys'
                                ]);
                                return _ctx.abrupt("return", [
                                    {
                                        name: 'rtl.dot',
                                        content: _this.tool.getFS().readFile('show.dot', {
                                            encoding: 'utf8'
                                        })
                                    },
                                    {
                                        name: 'luts.json',
                                        content: _this.tool.getFS().readFile('luts.json', {
                                            encoding: 'utf8'
                                        })
                                    }
                                ]);
    ...
    return $4cb31379c8be648f$export$47d7610350220620;
}($cYEEb.WorkerTool);
new $4cb31379c8be648f$export$47d7610350220620(1);
