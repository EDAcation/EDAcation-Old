...
importScripts("./fs.543b233b.js");
importScripts("./yosys.4165b9c3.js");
parcelRequire.register("jph2a", function(module, exports) {

var $6vt9n = parcelRequire("6vt9n");

var $9dvvU = parcelRequire("9dvvU");
"use strict";
var __dirname = "node_modules/nextpnr/dist";
...
var $7md52 = parcelRequire("7md52");

var $gNnSR = parcelRequire("gNnSR");
var Nextpnr = /*#__PURE__*/ function() {
    function Nextpnr(module) {
        $6vt9n.classCallCheck(this, Nextpnr);
        this.module = module;
    }
    $6vt9n.createClass(Nextpnr, [
        {
            key: "getModule",
                    ...
                    return (/*@__PURE__*/$parcel$interopDefault($9dvvU)).wrap(function _callee$(_ctx) {
                        while(1)switch(_ctx.prev = _ctx.next){
                            case 0:
                                ...
                                _ctx.t0 = Nextpnr;
                                _ctx.next = 4;
                                return $gNnSR($6vt9n.objectSpread({
...
parcelRequire.register("7md52", function(module, exports) {
module.exports = JSON.parse("{\"name\":\"nextpnr\",\"description\":\"WebAssembly version of nextpnr.\",\"version\":\"0.4.2\",\"license\":\"MIT\",\"contributors\":[\"Daniel Huisman <daniel@huisman.me> (https://danielhuisman.io)\"],\"repository\":\"github:EDAcation/nextpnr.js\",\"keywords\":[\"nextpnr\",\"fpga\",\"place\",\"route\",\"webassembly\",\"wasm\"],\"main\":\"./dist/index.js\",\"types\":\"./dist/index.d.ts\",\"files\":[\"dist\",\"LICENSE.md\",\"README.md\",\"package.json\"],\"scripts\":{\"lint\":\"eslint\",\"clean\":\"rm -rf dist && mkdir -p dist && cp build/* dist\",\"build\":\"yarn run clean && yarn run lint && tsc\",\"dev\":\"yarn run clean && tsc --watch\"},\"dependencies\":{\"@types/emscripten\":\"^1.39.5\",\"@types/node\":\"^17.0.22\"},\"devDependencies\":{\"@typescript-eslint/eslint-plugin\":\"^5.16.0\",\"@typescript-eslint/parser\":\"^5.16.0\",\"eslint\":\"^8.0.1\",\"eslint-config-google\":\"^0.14.0\",\"eslint-plugin-import\":\"^2.25.2\",\"ts-node\":\"^10.3.0\",\"typescript\":\"^4.4.4\"}}");

});

parcelRequire.register("gNnSR", function(module, exports) {
var $c3a3bfc555283721$var$__filename = "node_modules/nextpnr/dist/nextpnr-ice40.js";

var $5vuHX = parcelRequire("5vuHX");
var $c3a3bfc555283721$require$Buffer = $5vuHX.Buffer;
var $c3a3bfc555283721$var$__dirname = "node_modules/nextpnr/dist";
...
var $c3a3bfc555283721$var$Nextpnr = function() {
    var _scriptDir = typeof document !== 'undefined' && document.currentScript ? document.currentScript.src : undefined;
    if (typeof $c3a3bfc555283721$var$__filename !== 'undefined') _scriptDir = _scriptDir || $c3a3bfc555283721$var$__filename;
    return function(Nextpnr) {
        Nextpnr = Nextpnr || {};
        ...
        var Module = typeof Nextpnr != 'undefined' ? Nextpnr : {};
        ...
        if (ENVIRONMENT_IS_NODE) {
            if (typeof $iUMdb == 'undefined' || !$iUMdb.release || $iUMdb.release.name !== 'node') throw new Error('not compiled for this environment (did you build to HTML and try to run it not on the web, or set ENVIRONMENT to something - like node - and run it someplace else - like on the web?)');
            if (ENVIRONMENT_IS_WORKER) scriptDirectory = (parcelRequire("bvcWa")).dirname(scriptDirectory) + '/';
            else scriptDirectory = $c3a3bfc555283721$var$__dirname + '/';
 ...
 */ function UTF8ToString(ptr, maxBytesToRead) {
        ...
        var INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 240058368;
        ...
        assert(INITIAL_MEMORY == 240058368, 'Detected runtime INITIAL_MEMORY setting.  Use -sIMPORTED_MEMORY to define wasmMemory dynamically');
        ...
        function checkStackCookie() {
            ...
            if (cookie1 != 0x2135467 || cookie2 != 0x89BACDFE) abort('Stack overflow! Stack cookie has been overwritten at 0x' + max.toString(16) + ', expected hex dwords 0x89BACDFE and 0x2135467, but received 0x' + cookie2.toString(16) + ' 0x' + cookie1.toString(16));
            // Also test the global address 0 for integrity.
        ...
        var wasmBinaryFile;
        wasmBinaryFile = 'nextpnr-ice40.wasm';
        ...
        function createWasm() {
            ...
            /** @param {WebAssembly.Module=} module*/ function receiveInstance(instance, module) {
                ...
                //assert(wasmMemory.buffer.byteLength === 240058368);
            ...
            function instantiateAsync() {
                ...
                !ENVIRONMENT_IS_NODE && typeof fetch == 'function') return fetch(wasmBinaryFile, {
                    credentials: 'same-origin'
                }).then(function(response) {
     ...
     */ function setValue(ptr, value) {
                ...
                get_char: function get_char(tty) {
                    if (!tty.input.length) {
                        ...
                        if (ENVIRONMENT_IS_NODE) {
                            ...
                            var BUFSIZE = 256;
                            var buf = $c3a3bfc555283721$require$Buffer.alloc(BUFSIZE);
                            var bytesRead = 0;
                            try {
        ...
        var SYSCALLS = {
            ...
            doStat: function doStat(func, path, buf) {
                ...
                tempI64 = [
                    ...
                    (tempDouble = Math.floor(stat.atime.getTime() / 1000), +Math.abs(tempDouble) >= 1.0 ? tempDouble > 0.0 ? (Math.min(+Math.floor(tempDouble / 4294967296.0), 4294967295.0) | 0) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296.0) >>> 0 : 0)
                ], HEAP32[buf + 56 >> 2] = tempI64[0], HEAP32[buf + 60 >> 2] = tempI64[1];
                HEAPU32[buf + 64 >> 2] = 0;
                tempI64 = [
                    Math.floor(stat.mtime.getTime() / 1000) >>> 0,
                    (tempDouble = Math.floor(stat.mtime.getTime() / 1000), +Math.abs(tempDouble) >= 1.0 ? tempDouble > 0.0 ? (Math.min(+Math.floor(tempDouble / 4294967296.0), 4294967295.0) | 0) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296.0) >>> 0 : 0)
                ], HEAP32[buf + 72 >> 2] = tempI64[0], HEAP32[buf + 76 >> 2] = tempI64[1];
                HEAPU32[buf + 80 >> 2] = 0;
                tempI64 = [
                    Math.floor(stat.ctime.getTime() / 1000) >>> 0,
                    (tempDouble = Math.floor(stat.ctime.getTime() / 1000), +Math.abs(tempDouble) >= 1.0 ? tempDouble > 0.0 ? (Math.min(+Math.floor(tempDouble / 4294967296.0), 4294967295.0) | 0) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296.0) >>> 0 : 0)
        ...
        function emscripten_realloc_buffer(size) {
            try {
                ...
                wasmMemory.grow(size - buffer1.byteLength + 65535 >>> 16); // .grow() takes a delta compared to the previous size
                updateGlobalBufferAndViews(wasmMemory.buffer);
                return 1 /*success*/ ;
            } catch (e) {
                err1('emscripten_realloc_buffer: Attempted to grow heap from ' + buffer1.byteLength + ' bytes to ' + size + ' bytes, but got error: ' + e);
            }
        ...
        function _emscripten_resize_heap(requestedSize) {
            ...
            if (requestedSize > maxHeapSize) {
                err1('Cannot enlarge memory, asked to go up to ' + requestedSize + ' bytes, but the limit is ' + maxHeapSize + ' bytes!');
                return false;
            }
            ...
            err1('Failed to grow the heap from ' + oldSize + ' bytes to ' + newSize + ' bytes, not enough memory!');
            return false;
        }
        var ENV = {};
        ...
        function _getentropy(buffer, size) {
            ...
            for(var i = 0; i < size; i++)HEAP8[buffer + i >> 0] = _getentropy.randomDevice();
            return 0;
        }
        ...
        /** @param {boolean|number=} implicit */ function exitJS(status, implicit) {
            EXITSTATUS = status;
     ...
     */ function cwrap(ident, returnType, argTypes, opts) {
        ...
        /** @type {function(...*):?} */ var _main = Module["_main"] = createExportWrapper("__main_argc_argv");
        ...
        run();
        return Nextpnr.ready;
    };
}();
module.exports = $c3a3bfc555283721$var$Nextpnr;

});


var $9fd11fb910738f69$exports = {};

var $6vt9n = parcelRequire("6vt9n");

var $9dvvU = parcelRequire("9dvvU");

var $jph2a = parcelRequire("jph2a");

var $cYEEb = parcelRequire("cYEEb");
var $9fd11fb910738f69$var$WorkerNextpnr = /*#__PURE__*/ function(WorkerTool) {
    "use strict";
    $6vt9n.inherits($9fd11fb910738f69$var$WorkerNextpnr, WorkerTool);
    var _super = $6vt9n.createSuper($9fd11fb910738f69$var$WorkerNextpnr);
    function $9fd11fb910738f69$var$WorkerNextpnr() {
        $6vt9n.classCallCheck(this, $9fd11fb910738f69$var$WorkerNextpnr);
        return _super.apply(this, arguments);
    }
    $6vt9n.createClass($9fd11fb910738f69$var$WorkerNextpnr, [
        {
            key: "initialize",
            value: function initialize() {
                return $6vt9n.asyncToGenerator((/*@__PURE__*/$parcel$interopDefault($9dvvU)).mark(function _callee() {
                    var response, wasmBinary, nextpnr;
                    return (/*@__PURE__*/$parcel$interopDefault($9dvvU)).wrap(function _callee$(_ctx) {
                        while(1)switch(_ctx.prev = _ctx.next){
                            case 0:
                                _ctx.next = 2;
                                return fetch("https://unpkg.com/nextpnr@".concat($jph2a.Nextpnr.getVersion(), "/dist/nextpnr-ice40.wasm"));
                            case 2:
                                response = _ctx.sent;
                                _ctx.next = 5;
                                return response.arrayBuffer();
                            case 5:
                                ...
                                _ctx.next = 8;
                                return $jph2a.Nextpnr.initialize({
                            ...
                            case 8:
                                nextpnr = _ctx.sent;
                                return _ctx.abrupt("return", nextpnr);
                            case 10:
                            case "end":
                                return _ctx.stop();
                        }
        ...
        {
            key: "execute",
            value: function execute(filePath, file, directoryPath, directory) {
                var _this = this;
                return $6vt9n.asyncToGenerator((/*@__PURE__*/$parcel$interopDefault($9dvvU)).mark(function _callee() {
                    ...
                    return (/*@__PURE__*/$parcel$interopDefault($9dvvU)).wrap(function _callee$(_ctx) {
                        while(1)switch(_ctx.prev = _ctx.next){
                            case 0:
                                outputDirectory = file.getNameWithoutExtension();
                                outputPath = "".concat(directoryPath, "/").concat(outputDirectory);
                                _ctx.next = 4;
                                return directory.createDirectory(outputDirectory);
                            case 4:
                                ...
                                _this.tool.getModule().callMain([
                                    ...
                                    'qn32',
                                    '--write',
                                    "".concat(outputPath, "/routed.json"),
                                    '--placed-svg',
                                    "".concat(outputPath, "/placed.svg"),
                                    '--routed-svg',
                                    "".concat(outputPath, "/routed.svg")
                                ]);
                                return _ctx.abrupt("return", [
                                    "".concat(outputDirectory, "/routed.json"),
                                    "".concat(outputDirectory, "/placed.svg"),
                                    "".concat(outputDirectory, "/routed.svg")
                                ]);
                            case 6:
                            case "end":
                                return _ctx.stop();
    ...
    return $9fd11fb910738f69$var$WorkerNextpnr;
}($cYEEb.WorkerTool);
new $9fd11fb910738f69$var$WorkerNextpnr(2);
