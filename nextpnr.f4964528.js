...
importScripts("./fs.3a1513ad.js");
importScripts("./yosys.a45254f4.js");
                ...
                return $6vt9n.asyncToGenerator((/*@__PURE__*/$parcel$interopDefault($9dvvU)).mark(function _callee() {
                    ...
                    return (/*@__PURE__*/$parcel$interopDefault($9dvvU)).wrap(function _callee$(_ctx) {
                        while(1)switch(_ctx.prev = _ctx.next){
                            case 0:
                                _ctx.next = 2;
                                return directory.createDirectory(file.getNameWithoutExtension());
                            case 2:
                                outputPath = "".concat(directoryPath, "/").concat(file.getNameWithoutExtension());
