                ...
                return $6vt9n.asyncToGenerator((/*@__PURE__*/$parcel$interopDefault($9dvvU)).mark(function _callee() {
                    ...
                    return (/*@__PURE__*/$parcel$interopDefault($9dvvU)).wrap(function _callee$(_ctx) {
                        while(1)switch(_ctx.prev = _ctx.next){
                            ...
                            case 2:
                                content = _ctx.sent;
                                _this.tool.getFS().writeFile('luts.json', content);
                                ...
                                return _ctx.abrupt("return", [
                                    {
                                        name: 'routed.json',
                                        content: _this.tool.getFS().readFile('routed.json', {
                                            encoding: 'utf8'
                                        })
                                    },
                                    {
                                        name: 'placed.svg',
                                        content: _this.tool.getFS().readFile('placed.svg', {
                                            encoding: 'utf8'
                                        })
                                    },
                                    {
                                        name: 'routed.svg',
                                        content: _this.tool.getFS().readFile('routed.svg', {
                                            encoding: 'utf8'
                                        })
                                    }
                                ]);
