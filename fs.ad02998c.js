...
var $a702660d3b3b7923$var$handleMessage = function() {
    var _ref = $6vt9n.asyncToGenerator((/*@__PURE__*/$parcel$interopDefault($9dvvU)).mark(function _callee(event) {
        var sharedBuffer, arrayUint8, arrayInt32, port, storage, _data, storageId, path, operation, args, storage1, entry1, entries, type, size, result, resultArray, directory, directory1;
        return (/*@__PURE__*/$parcel$interopDefault($9dvvU)).wrap(function _callee$(_ctx) {
            while(1)switch(_ctx.prev = _ctx.next){
                case 0:
                    $1IjS8.debug('fs', event);
                    _ctx.t0 = event.data.type;
                    _ctx.next = _ctx.t0 === 'init' ? 4 : _ctx.t0 === 'worker' ? 9 : _ctx.t0 === 'storage' ? 15 : _ctx.t0 === 'call' ? 18 : 114;
                    break;
                case 4:
                ...
                case 18:
                    ...
                    $1IjS8.debug('fs', 'FS received request', storageId, path, operation);
                ...
                case 26:
                    entry1 = _ctx.sent;
                    $1IjS8.debug('fs', 'FS is waiting for FS lock...');
                    // Acquire FS lock
                    $a702660d3b3b7923$var$state.lockFs.acquire();
                    $1IjS8.debug('fs', 'FS has FS lock');
                    _ctx.prev = 30;
                    ...
                    _ctx.t1 = operation;
                    _ctx.next = _ctx.t1 === 'readdir' ? 36 : _ctx.t1 === 'rmdir' ? 43 : _ctx.t1 === 'unlink' ? 48 : _ctx.t1 === 'stat' ? 53 : _ctx.t1 === 'read' ? 66 : _ctx.t1 === 'truncate' ? 74 : _ctx.t1 === 'write' ? 88 : 102;
                    break;
                case 36:
                ...
                case 74:
                    ...
                    _ctx.next = 77;
                    return storage1.getEntry(path.slice(0, path.length - 1));
                case 77:
                    directory = _ctx.sent;
                    if (directory instanceof $1Nhm1.StorageDirectory) {
                        _ctx.next = 80;
                        break;
                    }
                ...
                case 80:
                    _ctx.next = 82;
                    return directory.createFile(path[path.length - 1]);
                case 82:
                    entry1 = _ctx.sent;
                case 83:
                    if (entry1 instanceof $1Nhm1.StorageFile) {
                ...
                case 85:
                    _ctx.next = 87;
                    return entry1.truncate(args.size);
                case 87:
                    return _ctx.abrupt("break", 102);
                case 88:
                    if (entry1) {
                    ...
                    return storage1.getEntry(path.slice(0, path.length - 1));
                case 91:
                    directory1 = _ctx.sent;
                    if (directory1 instanceof $1Nhm1.StorageDirectory) {
                        _ctx.next = 94;
                        break;
                    }
                    throw new Error('Parent of storage entry is not a directory.');
                case 94:
                    _ctx.next = 96;
                    return directory1.createFile(path[path.length - 1]);
                case 96:
                    entry1 = _ctx.sent;
                case 97:
                    if (entry1 instanceof $1Nhm1.StorageFile) {
                ...
                case 99:
                    _ctx.next = 101;
                    return entry1.write(args.buffer, args.start, args.end);
                case 101:
                    return _ctx.abrupt("break", 102);
                case 102:
                    _ctx.next = 110;
