                ...
                return $gTmwS.default((/*@__PURE__*/$parcel$interopDefault($9dvvU)).mark(function _callee() {
                    return (/*@__PURE__*/$parcel$interopDefault($9dvvU)).wrap(function _callee$(_ctx) {
                        while(1)switch(_ctx.prev = _ctx.next){
                            case 0:
                                _ctx.next = 2;
                                return _this.write(JSON.stringify(content));
                            case 2:
                            case "end":
                                return _ctx.stop();
                        }
                    ...
                    return (/*@__PURE__*/$parcel$interopDefault($9dvvU)).wrap(function _callee$(_ctx) {
                        while(1)switch(_ctx.prev = _ctx.next){
                            ...
                            case 7:
                                ...
                                throw new $bf020c4ba4602f5e$export$697502632950e9d3('Entry "'.concat(path[i], '" in path "').concat(path.join('/'), '" does not exist.'));
                            case 10:
                                if (!(i < path.length - 1)) {
                                    _ctx.next = 15;
                                    break;
